...
export default function Main() {
  ...
  const answers = [
    ...
    !question ? "Topa Sair comigo ? 😉❤ " : question,
  ]
              ...
              {!id ? (
                <>
                  <p className="font-semibold" align="center">"
                    <b>Clicou em SIM, agora não tem volta emm, vai ter que sair, Já vamo escolhendo as programações kkkk"</b> 
                  </p>

                  <p align="center">Valeu a pena ter te conhecido, só esperando pelo nossos encontros Camile Bueno ❤</p>
